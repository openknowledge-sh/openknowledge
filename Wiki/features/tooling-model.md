...
| --- | --- | --- |
| Create and maintain | `setup`, `agent`, `jobs`; advanced `scaffold` and `prompt` | Onboard a wiki, maintain it interactively, capture suggestions, and schedule repeatable work. |
