...
> specification from the GoogleCloudPlatform Knowledge Catalog repository.
> The upstream repository uses the Apache-2.0 license. Open Knowledge CLI is
> unofficial tooling for this specification and is not an official Google
> product.
