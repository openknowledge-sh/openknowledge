...
* tell the user how future agents should read exact Markdown with openknowledge get, build budget-bounded source context with openknowledge search, inspect the bundle tree with openknowledge list, and browse it with openknowledge view
